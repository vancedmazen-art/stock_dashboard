...
def stock_panel(source_df, session_key, metric_cols, show_levels=True, show_news=True):
    ...
    with col_chart:
        ...
        draw_candle_chart(selected, height=650,
                          ...
                          closed_trades_df=ticker_closed_arg, corporate_actions=actions_dict, load_chart_data_fn=load_chart_data)
...
with tab_charts:
    ...
    if chart_symbol:
        ...
        draw_candle_chart(chart_symbol, height=700,
                          ...
                          closed_trades_df=sym_closed_arg, corporate_actions=actions_dict, load_chart_data_fn=load_chart_data)
...
with tab_egx30:
    ...
    with col_egx_chart:
        draw_candle_chart('EGX30', height=650,
                          ...
                          closed_trades_df=egx30_closed_arg, corporate_actions=actions_dict, load_chart_data_fn=load_chart_data)
